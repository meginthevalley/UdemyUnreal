...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AMovingPlatform_Statics::NewProp_MyInt_MetaData[] = {
		...
		{ "Comment", "//to be able to see and edit in editor\n//add an integer variable\n" },
		{ "ModuleRelativePath", "MovingPlatform.h" },
		{ "ToolTip", "to be able to see and edit in editor\nadd an integer variable" },
	};
#endif
	...
	struct Z_CompiledInDeferFile_FID_meginthevalley_Documents_Udemy_Courses_Unreal_ObjectAssault_UnrealLearningKit_Source_UnrealLearningKit_MovingPlatform_h_Statics
	{
